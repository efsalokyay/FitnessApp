...
//Parcelable kullanma nedenimiz sınıfın içindekileri obje olarak sağa sola yollamayacağımız için
public class FitnessMove implements Parcelable {
    ...
    //Gelen parcelable nasıl okuyacağımıza karar veriyoruz.
    ...
    //parcelable ı neye yazacağımızı belirleyeceğiz.
    @Override
